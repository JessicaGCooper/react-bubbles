...
- [X] Describe how web servers work.
      You can make requests using AxiosWithAuth to create user credentials and then that user can be provided with a token by JWT every time they login, and using private routes (which checks if the user is authenticated).
